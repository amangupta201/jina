...
class JinaSingleRequestStreamingResponseRPCStub(object):
    """*
    jina request - streaming gRPC service.
    """
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.single_request_streaming = channel.unary_stream(
                '/jina.JinaSingleRequestStreamingResponseRPC/single_request_streaming',
                request_serializer=jina__pb2.DataRequestProto.SerializeToString,
                response_deserializer=jina__pb2.DataRequestProto.FromString,
                )


class JinaSingleRequestStreamingResponseRPCServicer(object):
    """*
    jina request - streaming gRPC service.
    """

    def single_request_streaming(self, request, context):
        """Pass in a Request and a filled Request with matches will be returned.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_JinaSingleRequestStreamingResponseRPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'single_request_streaming': grpc.unary_stream_rpc_method_handler(
                    servicer.single_request_streaming,
                    request_deserializer=jina__pb2.DataRequestProto.FromString,
                    response_serializer=jina__pb2.DataRequestProto.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'jina.JinaSingleRequestStreamingResponseRPC', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class JinaSingleRequestStreamingResponseRPC(object):
    """*
    jina request - streaming gRPC service.
    """

    @staticmethod
    def single_request_streaming(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/jina.JinaSingleRequestStreamingResponseRPC/single_request_streaming',
            jina__pb2.DataRequestProto.SerializeToString,
            jina__pb2.DataRequestProto.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
